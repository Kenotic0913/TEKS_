...
#                     ,aware_teks_display VARCHAR(75) NULL
...
def set_params(item, file_name):
    ...
    if tac_chapter == '111':
        regex = r'(\.\D\.)'
        aware_teks_display = re.sub(regex, '.', tac_teks_num[1:])
        ...
        return (tac_chapter, academic_subject, item_type, reporting_category, teks_number, 'NULL', teks_text, grade_levels, TEA_last_updated)
